        ...
        <center>
            <div class="form-container">
                <form action="registrar.php" method="post">
                    <label for="nombreu" style="color: white;">
                        Nombre:
                    </label>
                    <br>
                    <input type="text" id="nombreu" name="nombreu" required>
                    <br>            
                    <label for="fechanacimiento" style="color: white;">
                        Fecha de Nacimiento:
                    </label>
                    <br>
                    <input type="date" id="fechanacimiento" name="fechanacimiento" required>
                    <br>
                    <label for="calle" style="color: white;">
                        Calle:
                    </label>
                    <br>
                    <input type="text" id="calle" name="calle" required>
                    <br>
                    <label for="numero" style="color: white;">
                        Número:
                    </label>
                    <br>
                    <input type="number" id="numero" name="numero" required>
                    <br>
                    <label for="colonia" style="color: white;">
                        Colonia: 
                    </label>
                    <br>
                    <input type="text" id="colonoa" name="colonia" required>
                    <br>
                    <label for="telefono" style="color: white;">
                        Teléfono:
                    </label>
                    <br>
                    ...
                    <div class="center-content" style=" color:white;">
                        <a href="../inicio/login.php" class="login-link">
                            Login
                        </a>
                    </div>
                </form>
